...
def ospath(path) -> os.path:
    return path.replace('/', os.sep)


# Show all file names under the directory
def browseFileNames(path='.', ext='', recursive=True, name_only=True) -> list:
